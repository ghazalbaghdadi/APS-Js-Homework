...
const divNamesContainer = document.querySelector("#namesContainer");
names.forEach((element) => {
  let para = document.createElement("p");
  para.innerHTML = element.name;
  if(element.gender==='girl'){
  para.setAttribute('class','girl')
  }else{
  para.setAttribute('class','boy')
  }
  divNamesContainer.appendChild(para);
});
